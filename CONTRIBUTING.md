...
Utilize o comando `git checkout -b` para criar e alternar para a nova branch e nomeie-a como `feat/community/robinhodemorais`
> Exemplo: `git checkout -b feat/community/robinhodemorais`
